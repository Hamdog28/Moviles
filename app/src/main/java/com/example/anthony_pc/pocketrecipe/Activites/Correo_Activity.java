...
import com.example.anthony_pc.pocketrecipe.InternetDetector;
import com.example.anthony_pc.pocketrecipe.Utils;
...
public class Correo_Activity extends AppCompatActivity {
        ...
        findViewById(R.id.attachment).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utils.checkPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    ActivityCompat.requestPermissions(Correo_Activity.this,
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private Correo_Activity activity;

        MakeRequestTask(Correo_Activity activity, GoogleAccountCredential credential) {
